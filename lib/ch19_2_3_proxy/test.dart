...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(title: const Text("ProxyProvider Test"),),
        body: MultiProvider(
          providers: [
    ...
    return Container(
      ...
      child: Center(
        child: Column(
          ...
          children: [
            Text("Counter: ${counter.count}", style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
            Text("Sum: ${sum}", style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
