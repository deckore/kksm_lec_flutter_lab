...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(title: const Text('Inherited Test')),
...
class TestSubWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      color: Colors.yellow,
      child: Center(
        child: Text("SubWidget: ${count}", style: const TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold,)),
      ),
    );
  }
}
        ...
        return Center(
          child: Container(
            ...
            child: Column(
              ...
              children: [
                Text("TextWidget: ${counter}", style: const TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold,)),
                ElevatedButton(onPressed: () => setState(() => increment()), child: const Text("increment")),
                ElevatedButton(onPressed: () => setState(() => widget!.count++), child: const Text("count++")),
                TestSubWidget(),
              ],
            ),
          ),
